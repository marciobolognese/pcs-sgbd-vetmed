	...
	<div id="containerfuncionarioform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/FuncionarioController?action=edit"  class="form-horizontal" method="POST">
					    <div class="form-group">
					      <label for="idFuncionario" class="control-label col-sm-2">Id Funcionario:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="idFuncionario" name="idFuncionario" placeholder="Ex.: 999" readonly="true"
					    ...
					    <div class="form-group">
					      ...
					      <div class="col-sm-8">
					        ...
					        data-mask="dd/MM/yyyy" value="<c:out value="${funcionario.dataNascFuncionario}" />"/>
					      </div>
					    </div>
