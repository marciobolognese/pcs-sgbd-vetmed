...
<title>Consulta Sala</title>
 ...
 <body>
	...
	<div id="containeragendamentoform" class=container-fluid>
			...
			<div class="col-sm-8">
      			<h2>Consulta de Alocação de Salas</h2>
        		<br>
        		...
        		<div class="container">
					<div class="form-group">        
					   <div class="col-sm-3">
					      <a href="${pageContext.request.contextPath}/SalaController?action=list">Listar Salas</a>
					   </div>
					</div>
								...
								<tbody>						
								   <c:forEach items="${salas}" var="sala">   
								      <tr>
										...
										<td>${sala.alocada}</td>
										<td>${sala.setor}</td>
										<td><a href="SalaController?action=atualiza&codSala=<c:out value="${sala.codSala}"/>">
                    						<input type="button" class="btn btn-info" value="Editar"/></a></td>
                    					<td><a href="SalaController?action=delete&codSala=<c:out value="${sala.codSala}"/>">
			...
			<div class="col-sm-7">    
					  <div class="row">   
					      <div class="col-4 col-sm-offset-3">
					        <input id="btncadsala" type="button" class="btn btn-default" onclick ="redirectalocacaosala()" value="Alocar Sala para Procedimento"/>
					      </div>			      
					  </div>   
				</div>
	</div>
