	...
	<div id="containerprontuarioform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/PagamentoController?action=insert_c"  class="form-horizontal" method="POST">
					   		...
					   		<div class="col-sm-8">
 							 	<select class="form-control" id="convenio" name="convenio">
 									...
 									<c:forEach var="convenio" items="${convenios}">  
    									<option value="${convenio.CNPJConvenio}"><c:out value="${convenio.nomeConvenio}" /></option>  
  									</c:forEach>
  							 	</select>
  						 	</div>
					    </div>
