...
<body>
	...
	<div id="containeralocasalaform" class=container-fluid>
		...
		<div class="col-sm-8">
			...
			<div class="container">
				<form action="${pageContext.request.contextPath}/SalaController?action=edit" class="form-horizontal" method="POST">
					<div class="row">
						<div class="form-group">
							<label for="codSala" class="control-label col-sm-2">Codigo Sala:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="codSala" name="codSala" placeholder="Ex.: 999" readonly="true"
