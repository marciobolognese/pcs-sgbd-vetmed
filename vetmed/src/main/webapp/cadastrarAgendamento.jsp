	...
	<div id="containeragendamentoform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/AgendamentoController?action=insert"  class="form-horizontal" method="POST">
					    <div class="form-group">
					      <label for="codAgendamento" class="control-label col-sm-2">Codigo Agendamento:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="codAgendamento" name="codAgendamento" placeholder="Ex.: 999"
