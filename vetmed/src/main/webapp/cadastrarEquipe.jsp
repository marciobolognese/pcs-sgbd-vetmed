	...
	<div id="containerequipeform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/EquipeController?action=insert"  class="form-horizontal" method="POST">
					    <div class="form-group">
					      <label for="idEquipe" class="control-label col-sm-2">Id Equipe:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="idEquipe" name="idEquipe" placeholder="Ex.: 999"
