	...
	<div id="containerprontuarioform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/PagamentoController?action=insert"  class="form-horizontal" method="POST">
					    
					    <div class="form-group">
					      <label for="idPagto" class="control-label col-sm-2">Cod Pagamento:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="idPagto" name="idPagto" placeholder="Ex.: 999"
