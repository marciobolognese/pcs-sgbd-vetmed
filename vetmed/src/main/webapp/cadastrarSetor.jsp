	...
	<div id="containersetorform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/SetorController?action=insert"  class="form-horizontal" method="POST">
					    <div class="form-group">
					      <label for="idSetor" class="control-label col-sm-2">Id Setor:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="idSetor" name="idSetor" placeholder="Ex.: 999"
