...
<html lang="pt">
<head>
<title>Atualizar Convenio</title>
  	<meta charset="utf-8">
	...
	<div id="containerconvenioform" class=container-fluid>		
			...
			<div class="col-sm-8">
        		...
        		<div class="container">
					  ...
					  <form action="${pageContext.request.contextPath}/ConvenioController?action=edit"  class="form-horizontal" method="POST">
					    <div class="form-group">
					      <label for="CNPJConvenio" class="control-label col-sm-2">CNPJ Convenio:</label>
					      <div class="col-sm-8">          
					        	<input type="text" class="form-control" id="CNPJConvenio" name="CNPJConvenio" placeholder="Ex.: 9999" readonly="true"
					        		value="<c:out value="${convenio.CNPJConvenio}" />"/>
					      </div>
					    </div>
					    
					    <div class="form-group">
					      <label for="nomeConvenio" class="control-label col-sm-2">Nome Convenio:</label>
					      <div class="col-sm-8">          
